...
\begin{figure}[h]
    ...
    \caption{Confusion matrix for brain cancer set}\label{fig:MRICM}
\end{figure}
...
The result of the differing acitvation function performances are displayed combined in a line chart displaying the running accuracy and loss of the training set, shown in Fig.~\ref{fig:MRITP} (a) and (b).
